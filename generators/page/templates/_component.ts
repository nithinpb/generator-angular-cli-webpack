...
@Component({
  selector: 'app-<%= pluralPageName %>',
  templateUrl: './<%= pluralPageName %>.component.html',
  styleUrls: ['./<%= pluralPageName %>.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations : fuseAnimations
})
export class <%= capitalizedPluralPageName %>Component implements OnInit {
